const botConstants = {
  commands: {
    ...
    updateAbsoluteChannels: 'Обновить список безусловных каналов',
    updateSign: 'Обновить подпись',
    showAbsoluteChannels: 'Показать список безусловных каналов',
  ...
  messages: {
    successfullyUpdateSign: 'Подпись обновлена',
    errorUpdateSign: 'Ошибка обновления подписи',
    ...
    updateSubscribedChannels:
      ...
      updateAbsoluteChannels:
      'Внесите список никнеймов каналов. Каждый никнейм на отдельной строке. Каналы должны быть публичными!',
    updateSign: 'На первой строке введите ссылку, на второй строке текст ссылки',
  ...
  markups: {
    startMarkup: {
      keyboard: [
        ...
        [{ text: 'Показать список безусловных каналов' }, { text: 'Обновить список безусловных каналов' }],
        [{ text: 'Обновить подпись' }],
